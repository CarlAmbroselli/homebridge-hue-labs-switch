 ...
 */
export class HueLabsHomebridgePlatform implements DynamicPlatformPlugin {
  ...
  constructor(
    ...
    this.log.debug('Finished initializing hue platform:', this.config.name);
    this.hueApi = new HueApi(this.config.host!, this.config.token!, this);
